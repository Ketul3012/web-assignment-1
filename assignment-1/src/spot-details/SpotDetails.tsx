          ...
          <section className='flex-1 flex flex-col'>
              ...
              <div className='flex-1 md:border-r-[2px] md:border-borderColor md:mr-2'>
                <div className='flex flex-col mb-8 md:mb-0 md:mr-8 z-10 shadow-lg bg-backgroundColor flex-auto rounded-md'>
                  <div className='flex flex-col p-4'>
                    <h4>Spot details</h4>
                    <p>Parking Type : {parkingSpotDetails.parkingType}</p>
                    <p>Timing : Whole day</p>
                    <p>
                      Owner :{" "}
                  ...
                  <div className='flex flex-col p-4'>
                    ...
                    <p>{parkingSpotDetails.address.city}</p>
                    <p>
              ...
              <div className='flex-1 h-full'>
                <div className='flex flex-col h-full md:ml-4 z-10 shadow-lg bg-backgroundColor flex-auto rounded-md'>
                  <div className='flex flex-col px-4 pt-4 pb-3 w-full'>
                    ...
                    <button
                      className='w-full text-center py-3 mt-4 bg-black text-textSecondary rounded-lg z-20 shadow-md disabled:!bg-gray-700'
                      title={
            ...
            <div className='flex flex-col m-4' id='availability'>
              ...
              <div className='hidden md:block'>
                <Calendar
                  showDoubleView={true}
                  className='border-0 z-50 shadow-lg rounded-md !bg-backgroundColor'
                ...
                >
                  ...
                  >
                    <Popup>
                      ...
                      <p>{parkingSpotDetails.address.country}</p>
                    </Popup>
                  </Marker>
                </MapContainer>
              </div>
